        ...
        <div class="container-fluid ">
            ...
            <div class="container-fluid bg-white p-3 rounded mb-3">
                ...
                <div class="row d-flex justify-content-around align-items-center">
                    ...
                    <div class="col-sm-9">
                        <small class="fm-regular text-size-md">Soumission d'une offre ( Etape 1 )</small>
...
<div class="container-fluid p-lg-4 bg-white rounded">
    <div class=" col-sm-12">
        ...
        <form action="{{ route('sendStartBid')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                <div class="col-12">
                    <label for="intitule" class="fw-bold">Marche <span class="text-danger">(*)</span></label>
            ...
            <div class="row mb-3">
                <div class="col-12">
                    <label for="intitule" class="fw-bold">Cout de votre offre <span class="text-danger">(*)</span></label>
                    <input type="number" name="cout" id="name"
                        class="form-control  @error('cout') is-invalid @enderror" value="{{ old('cout') }} ">
                    @error('cout') <small class="text-danger">{{ $message }}</small>@enderror
                </div>
            </div>
            ...
            <div class="form-group">
                    ...
                    <textarea name="details" id="intitule" class="summernote  @error('details') is-invalid @enderror form-control"  value="{{ old('details') }}" ></textarea>
            ...
            <div class="d-flex justify-content-around mx-auto col-md-3 col-sm-12">
                ...
                <button class="btn btn-success text-size-xs" type="submit">SUIVANT</button>
            </div>
